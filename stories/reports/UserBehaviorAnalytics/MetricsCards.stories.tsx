...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "## Metrics Cards Component\n\nDisplays four key metrics for User Behavior Analytics: Avg Reporting Rate, Avg Time to Report, Training Completion, and Real Threats Reported. Each card shows the current value, trend vs last period (green up = positive for most metrics; for Time to Report, green down = positive as lower is better), and benchmark comparison.\n\nRelated: [DepartmentChart](./DepartmentChart), [ReportFilters](./ReportFilters), [User Behavior Report](./UserBehaviorPage)",
      },
    },
  },
  tags: ["autodocs"],
