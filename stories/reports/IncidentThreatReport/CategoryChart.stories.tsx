...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "## Incidents by Category Chart\n\nVertical bar chart (320px height) showing incident distribution by type (Phishing, Malware, Policy Violation, etc.). Each bar shows count with percentage change vs last week above (red = increase, green = decrease). Click bar to filter—updates Category filter dropdown (no chip), auto-scrolls to Recent Incidents table. Tap same bar again to clear. Height matches Severity Distribution chart.\n\nRelated: [Severity Chart](./SeverityChart), [Incidents Table](./IncidentsTable), [Report Filters](./ReportFilters)",
      },
    },
  },
  tags: ["autodocs"],
